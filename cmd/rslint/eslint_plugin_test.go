...
func newNativeLintConfigResolver(opts lintConfigResolverOptions) *lintConfigResolver {
	opts.RuleCatalog = catalog.Native()
...
func TestPluginConfigResolver_UsesGoOwnedCatalogKey(t *testing.T) {
	...
	r := pluginConfigResolver{
		lintResolver: newNativeLintConfigResolver(lintConfigResolverOptions{
			ConfigMap: configMap,
...
func TestPluginConfigResolver_Branches(t *testing.T) {
	...
	r := pluginConfigResolver{
		lintResolver: newNativeLintConfigResolver(lintConfigResolverOptions{ConfigMap: configMap}),
	}
...
func TestLintConfigResolver_UsesOnlyBoundTargetOwnership(t *testing.T) {
	...
	resolver := newNativeLintConfigResolver(lintConfigResolverOptions{
		ConfigMap: configMap,
		LintTargetBySourcePath: map[string]rslintconfig.DiscoveredLintTarget{
