...
export default defineConfig({
  ...
  include: [
    ...
    './tests/cli/js-config/eslint-plugin-fix.test.ts',
    './tests/cli/js-config/plugin-edge-cases.test.ts',
    ...
    './tests/cli/js-config/files-driven-tsconfig.test.ts',
    './tests/cli/js-config/files-driven-ignores.test.ts',
    './tests/cli/js-config/files-driven-plugins.test.ts',
    ...
    // ESLint plugin conformance — rslint vs ESLint structural diff
    './tests/conformance/unicorn-no-null.test.ts',
    './tests/conformance/unicorn-multi-rule.test.ts',
    './tests/conformance/unicorn-is-global-reference.test.ts',
    './tests/conformance/unicorn-combined-rules.test.ts',
    './tests/conformance/unicorn-aliased-prefix.test.ts',
    './tests/conformance/selector-combinators.test.ts',
    './tests/conformance/shebang-and-jsx-scope.test.ts',
    './tests/conformance/import-combined-rules.test.ts',
    './tests/conformance/react-hooks-combined-rules.test.ts',
    './tests/conformance/no-secrets-extended.test.ts',
    './tests/conformance/no-secrets.test.ts',
    './tests/conformance/no-secrets-pattern-match.test.ts',
    './tests/conformance/unicorn-extended-coverage.test.ts',
    './tests/conformance/import-extended-coverage.test.ts',
    './tests/conformance/react-hooks-extended-coverage.test.ts',
    './tests/conformance/typescript-eslint-coverage.test.ts',
    './tests/conformance/unicorn-deep-coverage.test.ts',
    './tests/conformance/unicorn-bulk-coverage.test.ts',
    './tests/conformance/unicorn-bulk2-coverage.test.ts',
    './tests/conformance/import-deep-coverage.test.ts',
    './tests/conformance/import-bulk-coverage.test.ts',
    './tests/conformance/react-hooks-deep-coverage.test.ts',
    './tests/conformance/typescript-eslint-deep-coverage.test.ts',
    './tests/conformance/typescript-eslint-bulk-coverage.test.ts',
    './tests/conformance/typescript-eslint-bulk2-coverage.test.ts',
    './tests/conformance/import-plugin.test.ts',
    './tests/conformance/react-hooks-plugin.test.ts',
    './tests/conformance/audit-api.test.ts',
    // monorepo multi-version eslintPlugins dispatch (per-config plugin instance)
    './tests/conformance/multi-version-monorepo.test.ts',
  ],
});
