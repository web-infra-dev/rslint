...
ruleTester.run('arrow-spacing', null as never, {
  valid: [
    ...
    { code: '() => {}', options: [{ after: true, before: true }] },
    { code: '(a) => {}', options: [{ after: true, before: true }] },

    // { before: false, after: true }
    { code: 'a=> a', options: [{ after: true, before: false }] },
    { code: '()=> {}', options: [{ after: true, before: false }] },
    { code: '(a)=> {}', options: [{ after: true, before: false }] },

    // { before: true, after: false }
    { code: 'a =>a', options: [{ after: false, before: true }] },
    { code: '() =>{}', options: [{ after: false, before: true }] },
    { code: '(a) =>{}', options: [{ after: false, before: true }] },

    // { before: false, after: false }
    { code: 'a=>a', options: [{ after: false, before: false }] },
    { code: '()=>{}', options: [{ after: false, before: false }] },
    { code: '(a)=>{}', options: [{ after: false, before: false }] },
    ...
    // No options — defaults to { before: true, after: true }
    { code: '(a) =>\n{}' },
    { code: '(a) =>\r\n{}' },
    { code: '(a) =>\n    0' },
    ...
    // TSFunctionType
    { code: 'type Foo = () => void' },
    { code: 'type Foo = ()=>void', options: [{ after: false, before: false }] },
  ...
  invalid: [
    ...
    },
    {
      ...
      output: '(a)  =>{}',
      options: [{ after: false }],
      errors: [{ column: 1, line: 2, messageId: 'unexpectedAfter' }],
    },
