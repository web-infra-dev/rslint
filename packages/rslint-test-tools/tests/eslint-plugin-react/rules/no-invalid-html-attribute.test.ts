...
ruleTester.run('no-invalid-html-attribute', {} as never, {
  ...
  invalid: [
    ...
    { code: '<html rel></html>', errors: [{ messageId: 'onlyMeaningfulFor' }] },
    {
      ...
      errors: [{ messageId: 'onlyMeaningfulFor' }],
    },
    ...
    },
    {
      ...
      errors: [{ messageId: 'spaceDelimited' }],
    },
    {
      code: '<a rel="noreferrer        noopener"></a>',
      errors: [{ messageId: 'spaceDelimited' }],
    ...
    },
    {
      ...
      errors: [{ messageId: 'neverValid' }, { messageId: 'spaceDelimited' }],
    },
    {
      code: '<a rel={"batgo noopener"}></a>',
      errors: [{ messageId: 'neverValid' }],
