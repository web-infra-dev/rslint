// Migrated from import-js/eslint-plugin-import import/order at 1a39fb8672c83f8781c3a97f02eee00a7a2f0253.
// Semantic duplicates across the core, TypeScript, and Babel suites are collapsed: 163 valid + 132 invalid.
...
ruleTester.run('order', rule, {
  ...
  invalid: [
    ...
    // Generic case from the Flow suite; it contains no Flow-only syntax.
    {
