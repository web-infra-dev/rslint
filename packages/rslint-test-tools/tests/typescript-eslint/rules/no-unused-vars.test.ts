...
ruleTester.run('no-unused-vars', {
  ...
  invalid: [
    ...
    {
      code: 'const foo = 5;',
      errors: [{ messageId: 'unusedVar', data: { varName: 'foo', action: 'defined', additional: '' } }],
    },
    {
      code: 'let foo = 5;',
      errors: [{ messageId: 'unusedVar', data: { varName: 'foo', action: 'defined', additional: '' } }],
    },
    {
      ...
      errors: [{ messageId: 'unusedVar', data: { varName: 'foo', action: 'assigned a value', additional: '' } }],
    },
    ...
    {
      code: 'function foo(bar) {}',
      errors: [{ messageId: 'unusedVar', data: { varName: 'bar', action: 'defined', additional: '' } }],
    },
    {
      code: 'function foo(bar) {}',
      options: [{ args: 'all' }],
    ...
    },
    {
      code: 'function foo(first, second) { console.log(second); }',
      options: [{ args: 'after-used' }],
      errors: [{ messageId: 'unusedVar', data: { varName: 'first', action: 'defined', additional: '' } }],
    },
    
    // Unused catch clause variables
    {
      code: 'try {} catch (e) {}',
      errors: [{ messageId: 'unusedVar', data: { varName: 'e', action: 'defined', additional: '' } }],
    },
    {
      code: 'try {} catch (e) {}',
    ...
    // Type-only usage for non-imports
    {
      code: 'const foo = 1; type Bar = typeof foo;',
      options: [{ vars: 'all' }],
      errors: [{ messageId: 'usedOnlyAsType', data: { varName: 'foo', action: 'defined', additional: '' } }],
    },
    {
      code: 'function foo() {} type Bar = typeof foo;',
      options: [{ vars: 'all' }],
    ...
    },
    {
      ...
      errors: [{ 
        ...
        data: { 
          varName: 'foo', 
          action: 'defined', 
          additional: '. Allowed unused elements of array destructuring must match ^_' 
        } 
      }],
    },
    ...
    },
    {
      ...
      errors: [{ 
        ...
        data: { 
          varName: '_foo', 
          additional: '. Used elements of array destructuring must not match ^_' 
        } 
      }],
    },
  ],
