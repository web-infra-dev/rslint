...
describe('no-confusing-void-expression', () => {
  test('rule tests', () => {
    ruleTester.run('no-confusing-void-expression', {
      valid: [
        '() => Math.random();',
        "console.log('foo');",
        'foo && console.log(foo);',
...
function notcool(input: string) {
  return input, console.log(input);
      ...
      `,
          errors: [
            { column: 18, line: 4, messageId: 'invalidVoidExprReturnLast' },
          ],
          output: `
        function f() {
          console.log('foo');
      ...
      `,
          errors: [
            { column: 24, line: 4, messageId: 'invalidVoidExprReturnLast' },
          ],
          output: null,
        },
        {
      ...
      `,
          errors: [
            { column: 26, line: 4, messageId: 'invalidVoidExprReturnLast' },
          ],
          output: `
        const f = function () {
          let undef = undefined;
      ...
      `,
          errors: [
            { column: 25, line: 4, messageId: 'invalidVoidExprReturnLast' },
          ],
          output: null,
        },
        {
