...
ruleTester.run('new-cap', {
  valid: [
    ...
    { code: 'foo?.bar();', languageOptions: { ecmaVersion: 2020 } },
    { code: '(foo?.bar)();', languageOptions: { ecmaVersion: 2020 } },
    { code: 'new (foo?.Bar)();', languageOptions: { ecmaVersion: 2020 } },
    {
      code: '(foo?.Bar)();',
      options: { properties: false },
    ...
    { code: 'Date?.UTC();', languageOptions: { ecmaVersion: 2020 } },
    { code: '(Date?.UTC)();', languageOptions: { ecmaVersion: 2020 } },
  ],
  invalid: [
    {
      code: 'var x = new c();',
      errors: [
        { messageId: 'lower', line: 1, column: 13, endLine: 1, endColumn: 14 },
      ],
    },
    {
      code: 'var x = new φ;',
    ...
    },
    {
      ...
      errors: [
        { messageId: 'lower', line: 1, column: 17, endLine: 1, endColumn: 18 },
      ],
    },
    {
      code: "var x = new a.b['c'];",
      errors: [
        { messageId: 'lower', line: 1, column: 17, endLine: 1, endColumn: 20 },
      ],
    },
    {
      code: 'var b = Foo();',
      errors: [
        { messageId: 'upper', line: 1, column: 9, endLine: 1, endColumn: 12 },
      ],
    },
    {
      code: 'var b = a.Foo();',
      errors: [
        { messageId: 'upper', line: 1, column: 11, endLine: 1, endColumn: 14 },
      ],
    },
    {
      code: "var b = a['Foo']();",
      errors: [
        { messageId: 'upper', line: 1, column: 11, endLine: 1, endColumn: 16 },
      ],
    },
    {
      code: 'var b = a.Date.UTC();',
      errors: [
        { messageId: 'upper', line: 1, column: 16, endLine: 1, endColumn: 19 },
      ],
    },
    {
      code: 'var b = UTC();',
    ...
    },
    {
      code: 'var a = B.C();',
      errors: [
        { messageId: 'upper', line: 1, column: 11, endLine: 1, endColumn: 12 },
      ],
    },
    {
      code: 'var a = B\n.C();',
      errors: [
        { messageId: 'upper', line: 2, column: 2, endLine: 2, endColumn: 3 },
      ],
    },
    {
      code: 'var a = new B.c();',
      errors: [
        { messageId: 'lower', line: 1, column: 15, endLine: 1, endColumn: 16 },
      ],
    },
    {
      code: 'var a = new B.\nc();',
      errors: [
        { messageId: 'lower', line: 2, column: 1, endLine: 2, endColumn: 2 },
      ],
    },
    {
      code: 'var a = new c();',
    ...
    },
    {
      ...
      errors: [
        { messageId: 'lower', line: 1, column: 18, endLine: 1, endColumn: 23 },
      ],
    },
    {
      code: 'var a = new b[`foo`];',
      languageOptions: { ecmaVersion: 6 },
      errors: [
        { messageId: 'lower', line: 1, column: 15, endLine: 1, endColumn: 20 },
      ],
    },
    {
      code: 'var a = b[`\\\nFoo`]();',
      languageOptions: { ecmaVersion: 6 },
      errors: [
        { messageId: 'upper', line: 1, column: 11, endLine: 2, endColumn: 5 },
      ],
    },
    {
      code: 'var x = Foo.Bar(42);',
