...
define.test({
  ...
  include: [
    ...
    './tests/eslint-plugin-node/rules/no-missing-require.test.ts',
    ...
    './tests/eslint-plugin-node/rules/no-unsupported-features/es-builtins.test.ts',
    ...
    './tests/eslint-plugin-node/rules/prefer-global/url-search-params.test.ts',
    ...
    './tests/eslint-plugin-jest/rules/prefer-expect-assertions.test.ts',
    ...
    './tests/eslint-plugin-jest/rules/prefer-lowercase-title.test.ts',
    './tests/eslint-plugin-jest/rules/prefer-importing-jest-globals.test.ts',
    './tests/eslint-plugin-jest/rules/prefer-mock-promise-shorthand.test.ts',
    './tests/eslint-plugin-jest/rules/prefer-mock-return-shorthand.test.ts',
    ...
    './tests/eslint-plugin-jest/rules/prefer-snapshot-hint.test.ts',
    ...
    './tests/rstest/rules/prefer-expect-assertions.test.ts',
    ...
    './tests/rstest/rules/prefer-mock-promise-shorthand.test.ts',
    ...
    './tests/rstest/rules/prefer-snapshot-hint.test.ts',
    ...
    './tests/rstest/rules/prefer-to-have-been-called-times.test.ts',
