...
6. **AST Traversal**: The linter traverses each file once using a DFS walk. It prunes syntax that TypeScript-Go synthesized by reparsing JSDoc comments; ESLint-compatible parsers expose that text through comment APIs rather than rule AST listeners.
