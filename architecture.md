...
| `internal/config/schemagen/`    | Model-backed root configuration-schema generation and drift checks                                                               | Reflects the JSON-visible configuration fields and bundled plugin names, preserves authored schema prose and conditional shapes, and is exercised by the repository's Go test matrix; the `tools/` command only invokes this package                                                                                                                                                                                                                                      |
...
| `tools/`                       | Shim, configuration-schema, and ts-go update scripts                                                                             | Generates `shim/` code, invokes the model-backed configuration-schema updater, and maintains the pinned `typescript-go` integration                                                                                                                                                                                                                                                                                                                                                                         |
