...
async function main() {
  ...
  console.log(chalk.gray('  1. Run: pnpm check:tsgo-release'));
  console.log(chalk.gray('  2. Commit the shared tsgo version bump'));
  console.log(
    chalk.gray(
      '  3. Run the "📦 Release tsgo" workflow for npm and crates.io together',
    ),
  );
}
