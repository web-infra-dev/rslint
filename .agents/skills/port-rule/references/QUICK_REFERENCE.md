...
| Scope-sensitive upstream behavior                                               | `internal/utils/scopeanalysis/`; [ESLint Scope Analysis](./UTILS_REFERENCE.md#internalutilsscopeanalysis---eslint-scope-analysis)                                                          |
