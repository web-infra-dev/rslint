...
// Keep lexical identities exact even when the underlying filesystem reports
// case-insensitive behavior: overlays may expose two distinct canonical files.
// Realpath below is the only authority that may merge aliases.
