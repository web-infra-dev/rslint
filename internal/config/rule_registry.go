...
func (r *RuleRegistry) GetEnabledRules(config RslintConfig, filePath string) ([]linter.ConfiguredRule, *MergedConfig) {
	mergedConfig := config.GetConfigForFile(filePath)
	if mergedConfig == nil {
