...
import (
	...
	"github.com/web-infra-dev/rslint/internal/rules/ban_ts_comment"
	"github.com/web-infra-dev/rslint/internal/rules/ban_tslint_comment"
	...
	"github.com/web-infra-dev/rslint/internal/rules/consistent_generic_constructors"
	"github.com/web-infra-dev/rslint/internal/rules/consistent_indexed_object_style"
	"github.com/web-infra-dev/rslint/internal/rules/consistent_return"
	"github.com/web-infra-dev/rslint/internal/rules/consistent_type_assertions"
	"github.com/web-infra-dev/rslint/internal/rules/consistent_type_definitions"
	"github.com/web-infra-dev/rslint/internal/rules/consistent_type_exports"
	"github.com/web-infra-dev/rslint/internal/rules/consistent_type_imports"
	...
	"github.com/web-infra-dev/rslint/internal/rules/explicit_function_return_type"
	"github.com/web-infra-dev/rslint/internal/rules/explicit_member_accessibility"
	"github.com/web-infra-dev/rslint/internal/rules/explicit_module_boundary_types"
	...
	"github.com/web-infra-dev/rslint/internal/rules/method_signature_style"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_confusing_non_null_assertion"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_duplicate_enum_values"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_empty_object_type"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_import_type_side_effects"
	"github.com/web-infra-dev/rslint/internal/rules/no_inferrable_types"
	"github.com/web-infra-dev/rslint/internal/rules/no_invalid_this"
	"github.com/web-infra-dev/rslint/internal/rules/no_invalid_void_type"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_misused_new"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_non_null_asserted_nullish_coalescing"
	"github.com/web-infra-dev/rslint/internal/rules/no_non_null_asserted_optional_chain"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_restricted_types"
	"github.com/web-infra-dev/rslint/internal/rules/no_shadow"
	"github.com/web-infra-dev/rslint/internal/rules/no_this_alias"
	"github.com/web-infra-dev/rslint/internal/rules/no_type_alias"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_unnecessary_type_constraint"
	"github.com/web-infra-dev/rslint/internal/rules/no_unnecessary_type_conversion"
	"github.com/web-infra-dev/rslint/internal/rules/no_unnecessary_type_parameters"
	...
	"github.com/web-infra-dev/rslint/internal/rules/no_unsafe_declaration_merging"
	"github.com/web-infra-dev/rslint/internal/rules/no_unsafe_enum_comparison"
	"github.com/web-infra-dev/rslint/internal/rules/no_unsafe_function_type"
