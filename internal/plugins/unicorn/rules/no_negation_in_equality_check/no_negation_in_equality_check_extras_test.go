...
func TestNoNegationInEqualityCheckStatementBoundaries(t *testing.T) {
	rule_tester.RunRuleTester(fixtures.GetRootDir(), "tsconfig.json", t, &no_negation_in_equality_check.NoNegationInEqualityCheckRule, nil, []rule_tester.InvalidTestCase{
		...
		// TypeScript assertions, instantiations, and non-null expressions.
		{Code: "foo\n!<boolean>bar === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo\n;<boolean>bar !== baz"}}}}},
		{Code: "foo<string>\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo<string>\n;(bar) !== baz"}}}}},
		{Code: "foo!\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo!\n;(bar) !== baz"}}}}},
		{Code: "foo<Array<string>>\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo<Array<string>>\n;(bar) !== baz"}}}}},
		{Code: "foo<Map<string, Array<number>>>\n![bar] === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo<Map<string, Array<number>>>\n;[bar] !== baz"}}}}},
		{Code: "new Foo<string>\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "new Foo<string>\n;(bar) !== baz"}}}}},
		{Code: "foo!.bar!\n!<boolean>bar === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo!.bar!\n;<boolean>bar !== baz"}}}}},
		{Code: "const typed = foo<string>\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "const typed = foo<string>\n;(bar) !== baz"}}}}},
		{Code: "const value = foo!\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "const value = foo!\n;(bar) !== baz"}}}}},
		{Code: "foo<string>;\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo<string>;\n(bar) !== baz"}}}}},
		{Code: "foo!;\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "foo!;\n(bar) !== baz"}}}}},
		{Code: "type Foo = Box<string>\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "type Foo = Box<string>\n(bar) !== baz"}}}}},
		{Code: "interface Foo<T> {}\n!(bar) === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "interface Foo<T> {}\n(bar) !== baz"}}}}},
		{Code: "function foo<T>() {}\n!<boolean>bar === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 2, Column: 1, EndLine: 2, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "function foo<T>() {}\n<boolean>bar !== baz"}}}}},
		{Code: "if (ready) !<boolean>bar === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 1, Column: 12, EndLine: 1, EndColumn: 13, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "if (ready) <boolean>bar !== baz"}}}}},
		{Code: "!<boolean>bar === baz", FileName: "probe.ts", Output: []string{}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "no-negation-in-equality-check/error", Message: "Negated expression is not allowed in equality check.", Line: 1, Column: 1, EndLine: 1, EndColumn: 2, Suggestions: []rule_tester.InvalidTestCaseSuggestion{{MessageId: "no-negation-in-equality-check/suggestion", Output: "<boolean>bar !== baz"}}}}},
	})
}
