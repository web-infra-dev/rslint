...
func TestNamedExtras(t *testing.T) {
	rule_tester.RunRuleTester(namedRoot(t, "testdata/extras.txtar"), "tsconfig.json", t, &named.NamedRule,
		[]rule_tester.ValidTestCase{
			...
			{Code: `const { required } = require(/** @type {string} */ ('conditional-package'))`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}},
			{Code: `const { required } = (/** @type {any} */ (require))('conditional-package')`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}},
			{Code: `const { required } = require(/** @satisfies {string} */ ('conditional-package'))`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}},
			{Code: `const { required } = (/** @satisfies {any} */ (require))('conditional-package')`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}},
			{Code: `const { required } = (/** @type {any} */ ((require)))(/** @satisfies {string} */ (('conditional-package')))`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}},
  ...
  "不存在" as alias
			...
			{Code: `const { imported } = require(/** @type {string} */ ('conditional-package'))`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}, Errors: []rule_tester.InvalidTestCaseError{{Message: "imported not found in 'conditional-package'", Line: 1, Column: 9, EndLine: 1, EndColumn: 17}}},
			{Code: `const { imported } = (/** @type {any} */ (require))('conditional-package')`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}, Errors: []rule_tester.InvalidTestCaseError{{Message: "imported not found in 'conditional-package'", Line: 1, Column: 9, EndLine: 1, EndColumn: 17}}},
			{Code: `const { imported } = require(/** @satisfies {string} */ ('conditional-package'))`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}, Errors: []rule_tester.InvalidTestCaseError{{Message: "imported not found in 'conditional-package'", Line: 1, Column: 9, EndLine: 1, EndColumn: 17}}},
			{Code: `const { imported } = (/** @satisfies {any} */ (require))('conditional-package')`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}, Errors: []rule_tester.InvalidTestCaseError{{Message: "imported not found in 'conditional-package'", Line: 1, Column: 9, EndLine: 1, EndColumn: 17}}},
			{Code: `const { imported } = (/** @type {any} */ ((require)))(/** @satisfies {string} */ (('conditional-package')))`, FileName: "consumer.mjs", TSConfig: "tsconfig.nodenext.json", Options: []any{map[string]any{"commonjs": true}}, Errors: []rule_tester.InvalidTestCaseError{{Message: "imported not found in 'conditional-package'", Line: 1, Column: 9, EndLine: 1, EndColumn: 17}}},
