...
func TestNoRestrictedRequireExtras(t *testing.T) {
	...
	runRestrictedRequireTests(t, root, []rule_tester.ValidTestCase{
		...
		// A non-absolute pattern tests RegExp conversion independently of host paths.
		...
		// Constant comparisons, coercions, and trivial BigInt powers.
		{Code: "require(0 < 1 ? 'fs' : 'path'); require(0 + true); require(0 - '1');", Options: []any{[]any{"fs", "1", "-1", "0"}}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "restricted", Message: "'fs' module is restricted from being used.", Line: 1, Column: 9, EndLine: 1, EndColumn: 30}, {MessageId: "restricted", Message: "'1' module is restricted from being used.", Line: 1, Column: 41, EndLine: 1, EndColumn: 49}, {MessageId: "restricted", Message: "'-1' module is restricted from being used.", Line: 1, Column: 60, EndLine: 1, EndColumn: 67}}},
		{Code: "require(0n ** 999999999999999999999n); require(1n ** 999999999999999999999n); require((-1n) ** 999999999999999999999n);", Options: []any{[]any{"fs", "1", "-1", "0"}}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "restricted", Message: "'0' module is restricted from being used.", Line: 1, Column: 9, EndLine: 1, EndColumn: 37}, {MessageId: "restricted", Message: "'1' module is restricted from being used.", Line: 1, Column: 48, EndLine: 1, EndColumn: 76}, {MessageId: "restricted", Message: "'-1' module is restricted from being used.", Line: 1, Column: 87, EndLine: 1, EndColumn: 118}}},
		{Code: "require((-1n) ** 999999999999999999998n); require(0n ** 0n);", Options: []any{[]any{"fs", "1", "-1", "0"}}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "restricted", Message: "'1' module is restricted from being used.", Line: 1, Column: 9, EndLine: 1, EndColumn: 40}, {MessageId: "restricted", Message: "'1' module is restricted from being used.", Line: 1, Column: 51, EndLine: 1, EndColumn: 59}}},
...
func TestNoRestrictedRequireResolverEdges(t *testing.T) {
	...
	runRestrictedRequireTests(t, root, []rule_tester.ValidTestCase{
		...
		{Code: "require('disabled');", Options: []any{[]any{filepath.Join(root.Dir, "server/**")}}, Settings: map[string]any{"node": map[string]any{"resolverConfig": map[string]any{"aliasFields": []any{"browser"}}}}},
		{Code: "require('./server/main');", Options: []any{[]any{filepath.Join(root.Dir, "server/main/entry.js")}}, Settings: map[string]any{"node": map[string]any{"resolverConfig": map[string]any{"mainFields": []any{}, "mainFiles": []any{}}}}},
	}, []rule_tester.InvalidTestCase{
		// Custom entries and package mappings select the path being restricted.
		{Code: "require('./server');", Options: []any{[]any{filepath.Join(root.Dir, "server/api.js")}}, Settings: map[string]any{"node": map[string]any{"resolverConfig": map[string]any{"mainFiles": []any{"api"}}}}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "restricted", Message: "'./server' module is restricted from being used.", Line: 1, Column: 9, EndLine: 1, EndColumn: 19}}},
		{Code: "require('./server/main');", Options: []any{[]any{filepath.Join(root.Dir, "server/api.js")}}, Settings: map[string]any{"node": map[string]any{"resolverConfig": map[string]any{"mainFields": []any{"module", "main"}}}}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "restricted", Message: "'./server/main' module is restricted from being used.", Line: 1, Column: 9, EndLine: 1, EndColumn: 24}}},
		{Code: "require('virtual'); require('./server/main');", Options: []any{[]any{filepath.Join(root.Dir, "server/api.js")}}, Settings: map[string]any{"node": map[string]any{"resolverConfig": map[string]any{"aliasFields": []any{"browser"}}}}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "restricted", Message: "'virtual' module is restricted from being used.", Line: 1, Column: 9, EndLine: 1, EndColumn: 18}, {MessageId: "restricted", Message: "'./server/main' module is restricted from being used.", Line: 1, Column: 29, EndLine: 1, EndColumn: 44}}},
