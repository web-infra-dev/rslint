...
var jestPaddingNames = padding.StatementNames{
	...
	"fdescribe":  padding.StatementDescribe,
	"fit":        padding.StatementTest,
	"it":         padding.StatementTest,
	"test":       padding.StatementTest,
	"xdescribe":  padding.StatementDescribe,
	"xit":        padding.StatementTest,
	"xtest":      padding.StatementTest,
}

var jestPaddingMessage = rule.RuleMessage{
	Id:          "missingPadding",
...
func MakePaddingRule(name string, kind PaddingRuleKind) rule.Rule {
	...
	return padding.NewRule(padding.Definition{
		...
		Message: jestPaddingMessage, Names: jestPaddingNames, Configs: configs,
	})
}
