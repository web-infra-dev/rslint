...
// back in. These characters have no single-character uppercase mapping, but
// simple case folding still joins them with another character.
...
func buildCaseTables(unicodeMode bool) (map[rune][]rune, [][]rune) {
	...
	// caseRanges. Folding reaches further than
