...
foo` + "`" + `${1 as any}` + "`" + `;
    `},
		...
		{Code: `doesNotExist(1 as any);`},
		{Code: `const foo = 1;
foo(1 as any);`},
		{Code: `declare function foo(arg: number): void;
foo(1, 1 as any, 2 as any);`},
		{Code: `declare function foo(arg: number, arg2: string): void;
foo(1, 'a');`},
		{Code: `declare function foo(arg: any): void;
foo(1 as any);`},
		{Code: `declare function foo(arg: unknown): void;
foo(1 as any);`},
		{Code: `declare function foo(...arg: number[]): void;
foo(1, 2, 3);`},
		{Code: `declare function foo(...arg: any[]): void;
foo(1, 2, 3, 4 as any);`},
		{Code: `declare function foo(arg: number, arg2: number): void;
const x = [1, 2] as const;
foo(...x);`},
		{Code: `declare function foo(arg: any, arg2: number): void;
const x = [1 as any, 2] as const;
foo(...x);`},
		{Code: `declare function foo(arg1: string, arg2: string): void;
const x: string[] = [];
foo(...x);`},
		{Code: `function foo(arg1: number, arg2: number) {}
foo(...([1, 1, 1] as [number, number, number]));`},
		{Code: `declare function foo(arg1: Set<string>, arg2: Map<string, string>): void;

const x = [new Map<string, string>()] as const;
foo(new Set<string>(), ...x);`},
		{Code: `declare function foo(arg1: unknown, arg2: Set<unknown>, arg3: unknown[]): void;
foo(1 as any, new Set<any>(), [] as any[]);`},
		{Code: `declare function foo(...params: [number, string, any]): void;
foo(1, 'a', 1 as any);`},
		{Code: `params`},
		{Code: `declare function foo<E extends string[]>(...params: E): void;

foo('a', 'b', 1 as any);`},
		{Code: `declare function toHaveBeenCalledWith<E extends any[]>(...params: E): void;
toHaveBeenCalledWith(1 as any);`},
		{Code: `declare function acceptsMap(arg: Map<string, string>): void;
acceptsMap(new Map());`},
		{Code: `type T = [number, T[]];
declare function foo(t: T): void;
declare const t: T;
...
const t: T = [];
foo(t);`},
		{Code: `function foo(templates: TemplateStringsArray) {}
foo\`},
		{Code: `;`},
		{Code: `function foo(templates: TemplateStringsArray, arg: any) {}
foo\`},
		{Code: `;`},
...
foo` + "`" + `${arg}` + "`" + `;
      `,
		...
		// Additional test cases from TypeScript-ESLint repository
		{Code: `declare function foo(arg: number): void;
foo(1 as any);`, Errors: []rule_tester.InvalidTestCaseError{}},
		{Code: `number`, Errors: []rule_tester.InvalidTestCaseError{}},
