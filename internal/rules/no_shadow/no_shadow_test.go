...
func TestNoShadowRule(t *testing.T) {
	rule_tester.RunRuleTester(
		...
		[]rule_tester.ValidTestCase{
			...
			{Code: `function foo() { var Object = 0; }`, Options: map[string]interface{}{"builtinGlobals": true}, Globals: map[string]any{"Object": "off"}},
			...
			{Code: `/* global top: off */ function foo() { var top = 0; }`, Options: map[string]interface{}{"builtinGlobals": true}, Globals: map[string]any{"top": "readonly"}},
	...
	interface Foo {
	  x: string;
		...
		[]rule_tester.InvalidTestCase{
			...
			{Code: `function foo() { var top = 0; }`, Globals: map[string]any{"top": "readonly"}, Options: map[string]interface{}{"builtinGlobals": true}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "noShadowGlobal", Message: "'top' is already a global variable."}}},
			...
			{Code: `/* global Object */ function foo() { var Object = 0; }`, Globals: map[string]any{"Object": "off"}, Options: map[string]interface{}{"builtinGlobals": true}, Errors: []rule_tester.InvalidTestCaseError{{MessageId: "noShadowGlobal", Message: "'Object' is already a global variable."}}},
