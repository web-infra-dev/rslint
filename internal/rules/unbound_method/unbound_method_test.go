...
oc.superLogThis();
    `},
		...
		{Code: `CursorKind.Identifier;`},
		{Code: `const x = CursorKind.Identifier;`},
		{Code: `const { Identifier } = CursorKind;`},
		{Code: `import { func } from './file'; func();`},
		{Code: `import { func } from './file'; const x = func;`},
		{Code: `import { func } from './file'; const { func: x } = { func };`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound();`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); const { unbound } = foo;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); const x = foo.unbound;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); if (foo.unbound) {}`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound?.();`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo?.unbound();`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); void foo.unbound;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); typeof foo.unbound;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound instanceof Function;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound in foo;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound as any;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound = null;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound += 1;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); delete foo.unbound;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); ++foo.unbound;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound++;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound || foo;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound && foo;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound ?? foo;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound ? foo : bar;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound + 1;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound - 1;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound * 1;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound / 1;`},
		...
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound <= 1;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound >= 1;`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound.bind(foo);`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound.call(foo);`},
		{Code: `class Foo { unbound = () => {}; } const foo = new Foo(); foo.unbound.apply(foo);`},
