...
var RestrictPlusOperandsRule = rule.Rule{
    ...
    if *opts.AllowNullish {
		...
		case 0: stringLike = "string"
		case 1: stringLike = "string, allowing a string + " + stringLikes[0]
		default: stringLike = "string, allowing a string + any of: " + strings.Join(stringLikes, ", ")
		}
