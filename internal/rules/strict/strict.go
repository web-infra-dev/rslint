...
//
// NOTE: Unlike ESLint, this rule does not yet consume
// languageOptions.sourceType, and rslint does not expose parserOptions
// ecmaFeatures.impliedStrict / ecmaFeatures.globalReturn. The rule detects ES
// modules via ast.IsExternalModule (presence of import/export) and treats every
// other file as a script. Consequences:
