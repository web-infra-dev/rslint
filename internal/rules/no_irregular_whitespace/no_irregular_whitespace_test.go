...
func TestNoIrregularWhitespace(t *testing.T) {
	rule_tester.RunRuleTester(
		...
		[]rule_tester.ValidTestCase{
			...
			{Code: "// \u000B", Options: []any{map[string]interface{}{"skipComments": true}}},
			{Code: "// \u000C", Options: []any{map[string]interface{}{"skipComments": true}}},
			{Code: "// \u0085", Options: []any{map[string]interface{}{"skipComments": true}}},
			{Code: "// \u00A0", Options: []any{map[string]interface{}{"skipComments": true}}},
			{Code: "// \u1680", Options: []any{map[string]interface{}{"skipComments": true}}},
			...
			// ---- skipRegExps: true ----
			{Code: "/\u000B/", Options: []any{map[string]interface{}{"skipRegExps": true}}},
			{Code: "/\u000C/", Options: []any{map[string]interface{}{"skipRegExps": true}}},
			{Code: "/\u0085/", Options: []any{map[string]interface{}{"skipRegExps": true}}},
			{Code: "/\u00A0/", Options: []any{map[string]interface{}{"skipRegExps": true}}},
			{Code: "/\u1680/", Options: []any{map[string]interface{}{"skipRegExps": true}}},
			...
			// ---- skipTemplates: true ----
			{Code: "`\u000B`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "`\u000C`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "`\u0085`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "`\u00A0`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "`\u1680`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			...
			{Code: "`\u3000${foo}\u3000`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			// Template in assignment
			{Code: "const error = ` \u3000 `;", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			// Template with newlines
			{Code: "const error = `\n\u3000`;", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "const error = `\u3000\n`;", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "const error = `\n\u3000\n`;", Options: []any{map[string]interface{}{"skipTemplates": true}}},
			{Code: "const error = `foo\u3000bar\nfoo\u3000bar`;", Options: []any{map[string]interface{}{"skipTemplates": true}}},

			// ---- skipJSXText: true ----
			{Code: "<div>\u000B</div>;", Tsx: true, Options: []any{map[string]interface{}{"skipJSXText": true}}},
			{Code: "<div>\u000C</div>;", Tsx: true, Options: []any{map[string]interface{}{"skipJSXText": true}}},
			{Code: "<div>\u0085</div>;", Tsx: true, Options: []any{map[string]interface{}{"skipJSXText": true}}},
			{Code: "<div>\u00A0</div>;", Tsx: true, Options: []any{map[string]interface{}{"skipJSXText": true}}},
			{Code: "<div>\u1680</div>;", Tsx: true, Options: []any{map[string]interface{}{"skipJSXText": true}}},
			...
			{Code: "`outer ${ `inner\u3000` } outer`", Options: []any{map[string]interface{}{"skipTemplates": true}}},
		},
		[]rule_tester.InvalidTestCase{
			...
			{
				Code:    "var any = '\u3000', other = '\u000B';",
				Options: []any{map[string]interface{}{"skipStrings": false}},
				Errors: []rule_tester.InvalidTestCaseError{
					{MessageId: "noIrregularWhitespace", Line: 1, Column: 12, EndLine: 1, EndColumn: 13},
					{MessageId: "noIrregularWhitespace", Line: 1, Column: 25, EndLine: 1, EndColumn: 26},
				},
			...
			{
				Code:    "var any = `\u3000`, other = `\u000B`;",
				Options: []any{map[string]interface{}{"skipTemplates": false}},
				Errors: []rule_tester.InvalidTestCaseError{
					{MessageId: "noIrregularWhitespace", Line: 1, Column: 12, EndLine: 1, EndColumn: 13},
					{MessageId: "noIrregularWhitespace", Line: 1, Column: 25, EndLine: 1, EndColumn: 26},
				},
