// The tests in this file exercise cross-product cases that are impractical to
// read in the upstream mirror: numeric key boundaries, nested containers,
// TypeScript/JSX wrappers, receiver precedence, and exact autofix preservation.
