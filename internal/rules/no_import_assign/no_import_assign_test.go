...
func TestNoImportAssignRule(t *testing.T) {
	rule_tester.RunRuleTester(
		...
		[]rule_tester.ValidTestCase{
			...
			// Read-only property access on namespace is not a write
			{Code: `import * as mod from 'mod'; console.log(mod.x)`},
		},
		// Invalid cases
		[]rule_tester.InvalidTestCase{
			...
			// Default import - array destructuring target
			{
				Code: `import mod from 'mod'; [mod] = [0]`,
				Errors: []rule_tester.InvalidTestCaseError{
