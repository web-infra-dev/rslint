...
func TestNoInnerDeclarationsRule(t *testing.T) {
	rule_tester.RunRuleTester(
		...
		[]rule_tester.ValidTestCase{
			...
			// Functions in blocks are valid by default (blockScopedFunctions "allow")
		...
		[]rule_tester.InvalidTestCase{
			// blockScopedFunctions "disallow" - function declarations in blocks
			{
				Code:    `if (foo) function f(){}`,
			...
			// "both" + blockScopedFunctions "disallow" - both function and var
			{
