...
func TestLanguageDefaultsPrecedenceAndApplyTo(t *testing.T) {
	...
	globalsInit, _ := ResolveLanguageDefaults("/repo/file.cjs", LanguageOptions{})
	globals := NewGlobals(
		LanguageOptions{},
		globalsInit,
...
func TestLanguageDefaultsCanBeDisabled(t *testing.T) {
	...
	globalsInit, _ := ResolveLanguageDefaults("file.cjs", LanguageOptions{})
	globals := NewGlobals(
		LanguageOptions{},
		globalsInit,
...
func TestLanguageDefaultsDoNotLeakThroughApplyToSeed(t *testing.T) {
	...
	globalsInit, _ := ResolveLanguageDefaults("file.js", LanguageOptions{})
