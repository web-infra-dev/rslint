...
func TestResolveLanguageDefaults(t *testing.T) {
	...
	tests := []struct {
		...
		{fileName: "/repo/file.ts", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.tsx", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.cts", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.mts", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.vue", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.foo", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.d.ts", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file", nonGlobalTopLevelScope: true, sourceType: "module"},
		{fileName: "/repo/file.CJS", nonGlobalTopLevelScope: true, sourceType: "module"},
